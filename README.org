...
It is a mirror of emacs-shell-script under [[https://github.com/eldriv/scripts/tree/main/emacs-shell-script][emacs-shell-script]] , instead of using bash script, I used clingon (CLI APP) to run my dev-env emacs into my machine
